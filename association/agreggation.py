...
class EmployeeOne:
    ...
    """Here the salary parameter reflects upon the object of Salary class we
...
"""
Here we are creating an object of the Salary class 
in which we are passing the required parameters
"""
salary = Salary(10000, 1500)
"""
Now we are passing the same salary object we created 
earlier as a parameter to EmployeeOne class
"""
